...
@Table(namingConvention = NamingConvention.LOWER_CASE_WITH_UNDERSCORE, comment = "Application record.")
public class ApplicationActivityRecord extends EntityBase
{
