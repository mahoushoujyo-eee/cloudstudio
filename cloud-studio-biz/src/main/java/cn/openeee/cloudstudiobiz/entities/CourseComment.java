...
@Table(namingConvention = NamingConvention.LOWER_CASE_WITH_UNDERSCORE, comment = "Course comment.")
public class CourseComment extends EntityBase
{
    ...
    @Column(comment = "Content.", type = "VARCHAR(500)", nullable = false)
